"""
Django settings for diting project.
...
MIDDLEWARE = [
    ...
    'diting.middleware.TimezoneMiddleware',
    'diting.middleware.DemoMiddleware',
]

ROOT_URLCONF = 'diting.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'diting.context_processor.diting_processor',
...
# WSGI_APPLICATION = 'diting.wsgi.applications'
...
LOGIN_INFO_DIR = os.path.join(PROJECT_DIR, "bash_files", "login_info")
