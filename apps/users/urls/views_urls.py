...
urlpatterns = [
    ...
    url(r'^phone_login$', views.PhoneLoginView.as_view(), name='phone-login'),
    url(r'^dynamic_login$', views.dynamicLoginView.as_view(), name='dynamic-login'),
    ...
    url(r'^user/download/qianxin-id.exe', views.UserDownloadView.as_view(), name='user-download'),
    ...
    url(r'^operation/$', views.HostInfoListView.as_view(), name='operation'),
    url(r'^appresourceops/$', views.AppListView.as_view(), name='appresourceops'),
    url(r'^script/$', views.ScriptListView.as_view(), name='script'),
    url(r'^fastops/$', views.FastopsListView.as_view(), name='fastops'),
    url(r'^omtask/$', views.OmtaskListView.as_view(), name='omtask'),
    url(r'^docs-list/$', views.DocsListView.as_view(), name='docs-list'),
